  ...
  return (
    <div className="flex flex-col items-center py-6 h-screen w-screen">
      ...
      <p className="w-6/12 text-m mb-8">
        MyCourseEvaluation serves as a hub for students to discuss courses. 
        As of now, student feedback and information for courses is fragmented across various sites and amongst course catalogs. 
        Rather than browsing multiple websites, users can use this site to leave their opinions on classes they have taken and browse other user posts to find out about classes they plan to take.
      </p>
      <h1 className="w-6/12 text-xl font-extrabold mb-4">Can I contribute?</h1>
      <p className="w-6/12 text-m mb-8">
        Sure! By simply leaving reviews in good faith and requesting to add schools, you already contribute the site's main content.
      </p>
      ...
      <div className="py-6">
        <a href="/" className="rounded-lg bg-blue-600 px-5 py-3 text-md font-medium text-white transition hover:bg-blue-700 focus:outline-none focus:ring">
          Return to home
        </a>
      </div>
    </div>
